...
public class UbicacionRepositoryAdapter implements UbicacionGateway {
    ...
    public UbicacionRepositoryAdapter(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public Ubicacion save(Ubicacion u) {
        ...
        try {
            tx.begin();
            UbicacionEntity e = new UbicacionEntity();
    ...
    public List<Ubicacion> findAll() {
        EntityManager em = emf.createEntityManager();
        try {
            return em.createQuery("select u from UbicacionEntity u", UbicacionEntity.class)
                    .getResultList()
                    .stream()
    ...
    public void deleteById(Long id) {
        ...
        try {
            tx.begin();
            UbicacionEntity e = em.find(UbicacionEntity.class, id);
