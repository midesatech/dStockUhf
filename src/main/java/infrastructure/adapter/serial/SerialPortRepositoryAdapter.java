 ...
 */
public class SerialPortRepositoryAdapter implements SerialPortRepository {
    
    private static final Logger logger = LogManager.getLogger(SerialPortRepositoryAdapter.class);
    
    private final SerialFactory serialFactory;
    private Serial serial;
    
    public SerialPortRepositoryAdapter(SerialFactory serialFactory) {
