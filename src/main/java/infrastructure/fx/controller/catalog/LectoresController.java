...
import domain.usecase.LectorUHFUseCase;
...
public class LectoresController {
    ...
    @FXML
    private TableView<LectorUHF> tbl;
    @FXML
    private TableColumn<LectorUHF, Long> colId;
    @FXML
    private TableColumn<LectorUHF, String> colCodigo;
    @FXML
    private TableColumn<LectorUHF, String> colDescripcion;
    @FXML
    private TableColumn<LectorUHF, String> colUbicacion;
    ...
    private final ObservableList<LectorUHF> data = FXCollections.observableArrayList();
    private final ObservableList<Ubicacion> ubicaciones = FXCollections.observableArrayList();

    private final LectorUHFUseCase useCase;
    private final UbicacionUseCase ubicacionUseCase;

    public LectoresController(LectorUHFUseCase useCase, UbicacionUseCase ubicacionUseCase) {
    ...
    public void initialize() {
        ...
        if (cmbUbicacion != null && ubicacionUseCase != null) {
            ubicaciones.setAll(ubicacionUseCase.listar());
    ...
    public void guardar() {
        try {
            ...
            LectorUHF seleccionado = tbl.getSelectionModel().getSelectedItem();
    ...
    public void eliminar() {
        LectorUHF s = tbl.getSelectionModel().getSelectedItem();
        if (s == null) {
